...
project = u'Graph Visibility and Image Parallel Execution Reduction'
copyright = u'2024, National Radio Astronomy Observatory'
...
html_logo = '_media/graphviper_logo.jpeg'
...
htmlhelp_basename = 'GraphVIPERdoc'
...
latex_logo = '_media/graphviper_logo.jpeg'

# Grouping the document tree into LaTeX files. List of tuples
# (source start file, target name, title,
#  author, documentclass [howto, manual, or own class]).
latex_documents = [
    (master_doc, 'GraphVIPER.tex', u'Graph Visibility and Image Parallel Execution Reduction',
...
man_pages = [
    (master_doc, 'GraphVIPER', u'Graph Visibility and Image Parallel Execution Reduction',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'GraphVIPER', u'Graph Visibility and Image Parallel Execution Reduction',
     author, 'GrpahVIPER', 'One line description of project.',
     'Miscellaneous'),
]
